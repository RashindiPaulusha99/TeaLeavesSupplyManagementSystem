...
public class Payment {
    ...
    public Payment(String paymentId, String supplierId, String paymentDate, String paymentTime, double teaPacket, double fertilizer, double advance, double discount, double totalPayment, int teaPacketQty, double teaPacketUnitPrice, double fertilizerQty, double fertilizerUnitPrice, double transport, double costForLeaves) {
